...
#ifndef MOBSHIELD_EMU_CHECKS_H
#define MOBSHIELD_EMU_CHECKS_H

#ifdef __cplusplus
extern "C" {
#endif

#define MOBSHIELD_EMU_OK 0
#define MOBSHIELD_EMU_DETECTED 1
#define MOBSHIELD_EMU_UNAVAILABLE 2
#define MOBSHIELD_EMU_ERROR -1
